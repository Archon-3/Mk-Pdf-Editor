...
import { GOOGLE_CLIENT_ID } from '../../../shared/constants/branding.ts'
...
export function GoogleContinueButton({ disabled, onToken }: { disabled: boolean; onToken: (token: string) => void }) {
